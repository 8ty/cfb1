...
const ACCOUNT = { //账号相关，安全性更高
  ...
  "user" : "YSYadmin", //博客后台用户名
  "password" : "YSY1403260048", //博客后台密码
  "third_token" : "cfblog9405", //开放token，当前仅允许访问/admin/search.xml，/admin/sitemap.xml时可用，在cfblog_token的头信息中传递
  "cacheZoneId":"24c87c8e5a53374de63507f14b043548",//区域 ID
  "cacheToken":"9SX_zFZ9LnMswU1BniroL8DVRnNj0D2yiMD6j1kF",//API token
...
const OPT = { //网站配置
  ...
  /*--前台参数--*/
  "siteDomain" : "wcyz.eu.org",// 域名(不带https 也不带/)
  "siteName" : "MY SPACESHIP",//博客名称
  "siteDescription":"welcome guys!    \n          all crew on board!" ,//博客描述
  "keyWords":"cloudflare,KV,workers,blog,free,testing,goodnews,tool,web,meta,society,life,share,book,feelings,movies",//关键字
  "logo":"https://i.postimg.cc/htSNW77k/all-sky.png",//JustNews主题的logo

  "theme_github_path":"https://cdn.jsdelivr.net/gh/8ty/cfblogtheme@main/",//主题路径
  "themeURL" : "https://raw.githubusercontent.com/8ty/cfblogtheme/main/", // 模板地址,以 "/"" 结尾
  ...
  "readMoreLength":0,//阅读更多截取长度
  "cacheTime" : 60*60*24*0.3, //文章在浏览器的缓存时长(秒),建议=文章更新频率
  "html404" : `<b>404</b>`,//404页面代码
  "codeBeforHead":`
  <script src="https://cdn.staticfile.org/jquery/2.2.4/jquery.min.js"></script>

    <link rel="icon" type="image/x-icon" href="https://i.postimg.cc/bNWvkpXf/s.png" />
               <link rel="Shortcut Icon" href="https://i.postimg.cc/bNWvkpXf/s.png">    
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7901026683522605"
     ...
     <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-K3GM6TKFFT"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-K3GM6TKFFT');
</script>
...
var typed = new Typed("#typedjs1", {
  strings: ['The question is not what you look at, but what you see.','I learned this, at least, by my experiment: that if one advances confidently in the direction of his dreams, and endeavors to live the life which he has imagined, he will meet with a success unexpected in common hours.','Dreams are the touchstones of our characters.','It is not what you look at that matters, it is what you see.','All good things are wild and free.'],
  startDelay: 0,
  typeSpeed: 90,
  backSpeed: 70,
  loop: true,
...
<script type="text/javascript">function show_runtime() {
        ...
        C = Math.floor((b - B) * 60);
        D = Math.floor((c - C) * 60);
        document.getElementById("webtime").innerHTML = "The site has been up and running  : " + A + "Days" + B + "Hours " + C + "Minutes" + D + "Seconds"
    }
    show_runtime();
</script>
...
jQuery(document).ready(function() {
    function c() {
        /* 排除首页（记得自行修改下首页地址） */
	if (location.href != "https://wcyz.eu.org/") { document.title = document[a] ? "Want You→《" + d + "》" : "NICE! →《" + d + "》" }
    }
...
Disallow: /admin`,//robots.txt设置
  ...
  "editor_page_scripts": `
    ...
    if($('#img').val()=="")$('#img').val('https://i.postimg.cc/htSNW77k/all-sky.png');
    //默认时间设置为当前时间
